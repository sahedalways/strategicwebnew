    ...
    <div class="modal fade" id="contactModal" tabindex="-1" aria-labelledby="contactModalLabel" aria-hidden="true"
        method="POST" data-action="<?php echo e(route('submit-contact-message')); ?>">
        <?php echo csrf_field(); ?>
    ...
    <!-- contact-model end -->
<?php /**PATH C:\xampp\htdocs\strategicwebnew\resources\views/frontend/components/_contact_form_modal.blade.php ENDPATH**/ ?>