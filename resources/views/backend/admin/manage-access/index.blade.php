                ...
                <div class="widget-content widget-content-area">
                    ...
                    <table id="style-3" class="style-3 table-hover table">
                        ...
                        <tbody>
                            ...
                            @foreach ($managerAccessItems as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="form-check form-switch">
                                            <input type="checkbox" role="switch"
                                                class="form-check-input access-item-checkbox" id="item_{{ $item->id }}"
...
@section('script')
    <script src="{{ asset('/admin_assets') }}/assets/js/manage-access/manage-access.js"></script>
