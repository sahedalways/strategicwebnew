...
@section('title', 'Edit Game Detail')
    ...
    <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="offset-1 col-xl-10 col-md-10 col-sm-10 col-10">
                <form id="my-form" class="needs-validation" action="{{ route('game-details.update', $gameDetail) }}"
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input id="title" type="text"
                                    ...
                                    value="{{ $gameDetail->title }}" name="title">
                                @error('title')
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea cols="10" rows="4" class="jqte-test" id="editor" name="details"> {{ $gameDetail->details }}</textarea>
                                @error('details')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input id="price" type="text"
                                    ...
                                    value="{{ $gameDetail->price }}" placeholder="ex. 250.00" name="price" required>
                                @error('price')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                @if (file_exists('images\game-details' . "/{$gameDetail->id}-1.{$gameDetail->image}"))
                                    <img id="image-preview"
                                        src="{{ asset('images\game-details' . "/{$gameDetail->id}-1.{$gameDetail->image}") ?? 'default_image_url' }}"
                                        alt="default_product_image" style="max-width: 100px; max-height: 100px;">
                                @endif
                                @error('image')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
