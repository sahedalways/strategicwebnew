        ...
        @if (in_array(auth()->user()->user_type, ['admin', 'manager']))
                    ...
                    <div class="widget widget-table-two">
                        <div class="widget-heading">
                            <h5 class="text-dark">
                                ...
                                <strong style="font-size: 20px;color: #9100ff">{{ $todaySalesCount }}</strong>
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            ">
                        <div class="widget-heading">
                            <h5 class="text-dark">
                                Monthly Sales
                                <strong style="font-size: 20px;color: #9100ff">{{ $monthlySalesCount }}</strong>
                            </h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget widget-table-two">
                        <div class="widget-heading">
                            <h5 class="text-dark">
                                ...
                                <strong style="font-size: 20px;color: #9100ff">{{ $totalSalesCount }}</strong>
                            </h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-table-two">
                            ...
                            <div class="widget-heading">
                                <h5 class="text-dark">
                                    Monthly Income
                                    <strong style="font-size: 20px;color: #9100ff">${{ $monthlyIncome }}</strong>
                        ...
                        <div class="widget widget-table-two">
                            ...
                            <div class="widget-heading">
                                <h5 class="text-dark">
                                    ...
                                    <strong style="font-size: 20px;color: #9100ff">${{ $totalIncome }}
                                    </strong>
                                </h5>
                            </div>
                        </div>
